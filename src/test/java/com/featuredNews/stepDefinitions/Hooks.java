...
public class Hooks {
	...
	public static void setup() throws IOException {
		driver = BaseClass.initializeBrowser();         //calling the initilizeBrowser method from BaseClass and storing it in driver or Initialize webdriver instance
		p = BaseClass.getProperties();       		   //calling the getProperties method from BaseClass and storing it in "p"   or Get properties for configuration      
